  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-3 col-lg-3 video" data-video="{{ $video->embed_url }}" data-index="<?php echo $i ?>">
      ...
      <ul class="col-sm-12 col-md-12 col-lg-12">
        ...
        <li><a class="edit" href="{{{ secure_url(URL::route('user.videos.edit', [$video->id], true)) }}}">Edit video</a></li>
        <li><a class="tags" href="{{{ secure_url(URL::route('user.tags.edit', [$video->id], true)) }}}">View/Edit tags</a></li>
        <li><a class="delete" href="{{{ secure_url(URL::route('user.videos.delete', [$video->id], true)) }}}">Delete video</a></li>
      </ul>
    </div>
    @endforeach
