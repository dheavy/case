...
$api->version('v1', function ($api) {
  ...
  $api->get('invite/{email}/{code}', ['as' => 'invite.claim', 'uses' => 'Mypleasure\Api\V1\Controller\InviteController@claim']);
  ...
  $api->post('users/invited', ['as' => 'users.invited',    'uses' => 'Mypleasure\Api\V1\Controller\UserController@createFromInvite']);
