...
*/
$config = array();
$config['MEMCACHEDCLOUD_SERVERS_HOST'] = (getenv("MEMCACHEDCLOUD_SERVERS") && array_key_exists(getenv("MEMCACHEDCLOUD_SERVERS"), 'host')) ? getenv("MEMCACHEDCLOUD_SERVERS")['host'] : '';
$config['MEMCACHEDCLOUD_SERVERS_PORT'] = (getenv("MEMCACHEDCLOUD_SERVERS") && array_key_exists(getenv("MEMCACHEDCLOUD_SERVERS"), 'port')) ? (int)getenv("MEMCACHEDCLOUD_SERVERS")['port'] : '';
